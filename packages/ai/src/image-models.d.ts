...
> = (typeof IMAGE_MODELS)[TProvider][TModelId] extends {
	api: infer TApi;
}
	? TApi extends ImagesApi
		...
		: never
	: never;
export declare function getImageModel<
	TProvider extends KnownImagesProvider,
	TModelId extends keyof (typeof IMAGE_MODELS)[TProvider],
...
export declare function getImageModels<TProvider extends KnownImagesProvider>(
	provider: TProvider,
