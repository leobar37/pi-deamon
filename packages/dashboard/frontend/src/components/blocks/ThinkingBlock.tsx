/**
 * ThinkingBlock — collapsible thinking/reasoning content.
 *
 * Shows a summary line that expands to reveal the full thinking.
 * Remembers expand/collapse state per block instance.
 */
